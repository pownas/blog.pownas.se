...
### Vidareutveckling av `field`-nyckelordet
...
### Smidigare hantering av strukturer och samlingar
...
### Smartare Dynamic PGO och loop-optimering
...
### Förbättrad hårdvaruacceleration (Vectorization)
...
### `System.Text.Json` blir ännu snabbare för Source Generators
...
## 🛠️ 4. SDK och verktyg: Snabbare inre loopar
...
### Snabbare `dotnet watch` och inkrementella byggen
...
### Förbättrad terminal-diagnostik och CPM-insikter
